...
public class CalculateIndexForLemmaOnPage {
 ...
 public CalculateIndexForLemmaOnPage () {
    ...
    public static  String getIndexes (String titleText, String bodyText, int pageId, Site site) {
        ...
        for (String lemma : lemmasBody.keySet()) {
            ...
            insertQuery.append((insertQuery.length() == 0 ? "" : ",") + "('" + dbMethods.getLemmaIdByUK(lemma, site).getId()
                    + "', '" + pageId + "', '" + rank + "')");
        }
