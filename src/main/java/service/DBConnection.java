...
public class DBConnection {
    ...
    public static StringBuilder getPagesBegin(String lemma, StringBuilder sites) throws SQLException {
    ...
    public static StringBuilder getPages(String lemma, StringBuilder values) throws SQLException {
        StringBuilder newValues = new StringBuilder();
        ResultSet rs = DBConnection.getConnection().createStatement()
                .executeQuery("SELECT DISTINCT(ind.page_id) FROM `index` ind, lemma l WHERE " +
