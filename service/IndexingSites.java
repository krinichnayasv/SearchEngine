...
public class IndexingSites extends RecursiveAction {
    ...
    public IndexingSites(Node node, Site site, DBMethods dbMethods) {
        ...
        // start indexing/reindexing sites
    ...
    private Page setPage(String url, Site site, int statusCode, String htmlOfSite) throws SQLException {
   ...
   //         DBConnection.updateSiteOnIndexing(site.getId());
...
//                    List<Index> indexList = CalculateIndexForLemmaOnPage.getIndexForLemmas(titleText,
//                                  bodyText.concat(" ").concat(metaContent), page.getId());
//                    dbMethods.insertIntoIndexAll(indexList);
